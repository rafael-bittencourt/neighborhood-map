...
var Location = function(data) {
	...
	$.getJSON(foursquareURL).done(function(data) {
		...
		infoContent = '<div><h3>' + results.name +
					  '</h3><h4>' + results.categories[0].name + 
					  '</h4><ul class="list_locations"><li>Address: ' + results.location.address + 
					  '</li><li>Phone: ' + results.contact.formattedPhone + 
					  '</li><li>URL: <a href="' + results.url + '">' + results.url +'</a></li></ul></div>';
